...
CREATE TABLE IF NOT EXISTS `mydb`.`ClockingIN` (
  ...
  `Early_Leave_Status` TINYINT NULL COMMENT 'Flag for early leave',
  `ClockingINcol` VARCHAR(45) NULL,
  `Early_Leave_id` INT NOT NULL COMMENT 'ID of what kind of early reason.',
